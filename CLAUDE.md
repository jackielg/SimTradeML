...
## Stack
Python >=3.10, Poetry, XGBoost >=1.7,<3.0, scikit-learn, src/ layout
...
This project is indexed by GitNexus as **SimTradeML** (1054 symbols, 1689 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
